...
DEFAULT_COMPARISON_CONFIGURATIONS = [
    ...
    {"name": "Hybrid RRF (alpha=0.3)", "mode": "hybrid", "top_k": 1, "alpha": 0.3},
    {"name": "Hybrid RRF (alpha=0.3)", "mode": "hybrid", "top_k": 3, "alpha": 0.3},
    {"name": "Hybrid RRF (alpha=0.3)", "mode": "hybrid", "top_k": 5, "alpha": 0.3},
    {"name": "Hybrid RRF (alpha=0.5)", "mode": "hybrid", "top_k": 1, "alpha": 0.5},
    {"name": "Hybrid RRF (alpha=0.5)", "mode": "hybrid", "top_k": 3, "alpha": 0.5},
    {"name": "Hybrid RRF (alpha=0.5)", "mode": "hybrid", "top_k": 5, "alpha": 0.5},
    {"name": "Hybrid RRF (alpha=0.7)", "mode": "hybrid", "top_k": 1, "alpha": 0.7},
    {"name": "Hybrid RRF (alpha=0.7)", "mode": "hybrid", "top_k": 3, "alpha": 0.7},
    {"name": "Hybrid RRF (alpha=0.7)", "mode": "hybrid", "top_k": 5, "alpha": 0.7},
]
